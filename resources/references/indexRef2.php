...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
    ...
    <form method="POST">
        <input type="submit" name="themeCh" class="w3-bar-item w3-button w3-padding-large w3-border-bottom w3-hover-<?php echo ($theme); echo (" w3-border-$theme"); ?>" value="CHANGE THEME" />
    </form>
    ...
    <a id="account" href="/account.php" class="w3-bar-item w3-button w3-padding-large w3-hide w3-hover-<?php echo ($theme); if ($_SERVER['PHP_SELF'] == '/account.php') {echo (" w3-$theme");} ?>">
    ...
    <div><a id="login" href="/" class="w3-bar-item w3-button w3-padding-large w3-display-bottomleft w3-leftbar w3-hover-<?php echo ($theme); echo (" w3-border-$theme"); ?>">
        <i class="fa fa-sign-in w3-xxlarge"></i>
        <p>Login</p>
    </a></div>
    <div><a id="logout" href="/" class="w3-bar-item w3-button w3-padding-large w3-display-bottomleft w3-hide w3-leftbar w3-hover-<?php echo ($theme); echo (" w3-border-$theme"); ?>">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="/resources/images/AUBackground.jpg" alt="boy" class="w3-image" width="992" height="1108">
  </header>
